...
```{r num-ord_10, fig.width=16, fig.height=2.4}
...
```{r num-ord_11, fig.width=16, fig.height=2.4, warning=FALSE, message=FALSE}
gridExtra::grid.arrange(brinton::plotup(esoph, c("agegp", "ncontrols"), 'blank'),
...
```{r num-ord_12, fig.width=16, fig.height=2.4}
...
```{r num-ord_13, fig.width=16, fig.height=2.4}
gridExtra::grid.arrange(brinton::plotup(esoph, c("agegp", "ncontrols"), 'blank'),
...
```{r fac-num_10, fig.width=16, fig.height=2.4}
...
```{r fac-num_11, fig.width=16, fig.height=2.4}
gridExtra::grid.arrange(brinton::plotup(iris, c('Species', 'Petal.Width'), 'blank'),
...
```{r fac-num_12, fig.width=16, fig.height=2.4}
...
```{r fac-num_13, fig.width=16, fig.height=2.4}
gridExtra::grid.arrange(brinton::plotup(iris, c('Species', 'Petal.Width'), 'blank'),
