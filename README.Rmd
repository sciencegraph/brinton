...
```{r readme01, echo=FALSE, eval=TRUE, out.width = "90%"}
knitr::include_graphics("vignettes/figures/readme_01.png")
```
...
```{r readme02, echo=FALSE, eval=TRUE, out.width = "90%"}
knitr::include_graphics("vignettes/figures/readme_02.png")
```
...
```{r readme03, echo=FALSE, eval=TRUE, out.width = "90%"}
knitr::include_graphics("vignettes/figures/readme_03.png")
```
...
```{r readme04, echo=FALSE, eval=TRUE, out.width = "90%"}
knitr::include_graphics("vignettes/figures/readme_04.png")
```
...
```{r readme05, echo=FALSE, eval=TRUE, out.width = "90%"}
knitr::include_graphics("vignettes/figures/readme_05.png")
```
...
```{r readme06, echo=FALSE, eval=TRUE, out.width = "90%"}
knitr::include_graphics("vignettes/figures/readme_06.png")
```
...
```{r readme07, echo=FALSE, eval=TRUE, out.width = "90%"}
knitr::include_graphics("vignettes/figures/readme_07.png")
```
...
```{r readme08, echo=FALSE, eval=TRUE, out.width = "90%"}
knitr::include_graphics("vignettes/figures/readme_08.png")
```
...
```{r plotspane1, evak = FALSE}
plotup(esoph, c("agegp", "alcgp"), "color stacked bar graph", output = "html")
```

```{r readme09, echo=FALSE, eval=TRUE, out.width = "90%"}
knitr::include_graphics("vignettes/figures/readme_09.png")
```
